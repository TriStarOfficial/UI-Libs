...
local Themes = {
	...
	GrayContrast = Color3.fromRGB(35, 35, 35),
	DarkContrast = Color3.fromRGB(29, 29, 29),
	TextColor = Color3.fromRGB(255,255,255),
	SectionContrast = Color3.fromRGB(39, 39, 39),
	DropDownListContrast = Color3.fromRGB(34, 34, 41),
	CharcoalContrast = Color3.fromRGB(21,21,21),
}
...
function Library:CreateMain(Options)
	...
	Main.Uplinegradient = Library:Create("UIGradient", {
		Color = ColorSequence.new{
			ColorSequenceKeypoint.new(0.00, Color3.fromRGB(62, 172, 112)),
			ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 248, 248)),
			ColorSequenceKeypoint.new(1.00, Color3.fromRGB(11, 176, 182))
		}
	})
